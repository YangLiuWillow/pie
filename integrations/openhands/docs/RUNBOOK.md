...
For the verified internal API of `openhands-sdk`, see [`SDK_INTERNALS.md`](SDK_INTERNALS.md). For the shortest path from an empty machine to a working agent, see [`TUTORIAL_CODER_SESSION.md`](TUTORIAL_CODER_SESSION.md); this runbook's Layers A–F only cover local CPU plumbing checks.
...
cd $REPO/integrations/openhands
python3 -m venv .venv
...
```bash
PIE=$REPO/target/release/pie
WASM=$REPO/inferlets/openhands-completion/target/wasm32-wasip2/release/openhands_completion.wasm
MAN=$REPO/inferlets/openhands-completion/Pie.toml
CFG=$REPO/integrations/openhands/tests/fixtures/pie_dummy_config.toml
...
```bash
cd $REPO/integrations/openhands
PIE_BIN=$REPO/target/release/pie \
PIE_WASM=$REPO/inferlets/openhands-completion/target/wasm32-wasip2/release/openhands_completion.wasm \
PIE_MANIFEST=$REPO/inferlets/openhands-completion/Pie.toml \
PIE_CONFIG=$REPO/integrations/openhands/tests/fixtures/pie_dummy_config.toml \
...
WASM = "$REPO/inferlets/openhands-completion/target/wasm32-wasip2/release/openhands_completion.wasm"
MANIFEST = "$REPO/inferlets/openhands-completion/Pie.toml"
...
```bash
PIE=$REPO/target/release/pie
CFG=$REPO/integrations/openhands/tests/fixtures/pie_portable_config.toml
