...
| [`docs/GPU_BENCHMARK.md`](docs/GPU_BENCHMARK.md) | Running the benchmarks on a Slurm cluster |
| [`docs/CODE_WALKTHROUGH.md`](docs/CODE_WALKTHROUGH.md) | Tour of the source |
