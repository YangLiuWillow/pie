...
OUT=/private/tmp/claude-501/-Users-liuyang-Documents-Liszt-ai-pie-opencode/e6929145-9422-4835-9670-317e9f8eebd9/scratchpad/spec-ab
...
run_pie() {   # $1 = spec on|off, $2 = tag
    ...
    PIE_BASE_URL=http://127.0.0.1:8080 python3 integrations/opencode/bench_ab.py \
        --arm "$2" --model qwen3-coder-30b --turns $TURNS --max-tokens $MAXTOK \
...
echo "=== 1/4 pie, speculation ON ==="   ; run_pie  on  pspec
echo "=== 2/4 vLLM, speculation ON ==="  ; run_vllm on  vspec
echo "=== 3/4 pie, speculation OFF ===" ; run_pie  off pctl
echo "=== 4/4 vLLM, speculation OFF ===" ; run_vllm off vctl
